...
discord_bot_spec = ["implementation_id", "discord_bot", 
         ...
         "language",          "Python", 
         "lang_type",         "SCRIPT",
         "conf.default.channel_id", " 0000",
         "conf.default.bot_token", " token",

         "conf.__widget__.channel_id", "text",
         "conf.__widget__.bot_token", "text",

         "conf.__type__.channel_id", "short",
         "conf.__type__.bot_token", "string",
...
class discord_bot(OpenRTM_aist.DataFlowComponentBase):
    ...
    def __init__(self, manager):
        ...
        """
        テキストを送信したいチャンネルのIDを入力してください。
         - Name:  channel_id
         - DefaultValue:  0000
        """
        self._channel_id = [ 0000]
        """
        使用したいbotのトークンを入力してください。
         - Name:  bot_token
         - DefaultValue:  token
        """
    ...
    def onInitialize(self):
        ...
        self.bindParameter("channel_id", self._channel_id, " 0000")
        self.bindParameter("bot_token", self._bot_token, " token")
    ...
    def onActivated(self, ec_id):
        # 使用例
        self.channel_id = self._channel_id[0] # 送信したいチャンネルのID
        self.bot_token = self._bot_token[0] # ボットのトークン
